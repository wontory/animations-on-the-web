  ...
  return (
    <MotionConfig transition={{ type: "spring", duration: 0.5, bounce: 0.2 }}>
      ...
      >
                ...
                return (
                  ...
                  >
                    <motion.div
                      ...
                      className="pointer-events-none absolute top-2 right-2 flex h-4 w-4 items-center justify-center rounded-full border border-white/60"
                    >
                      <AnimatePresence>
                        {isSelected ? (
                          <motion.div
          ...
          {imagesToRemove.length > 0 && !readyToRemove ? (
            ...
            >
              <div className="flex w-full justify-between gap-1">
                <button
                  type="button"
                  className="flex w-12 flex-col items-center gap-[1px] rounded-lg bg-[#F9F9F8] pt-[6px] pb-1 font-medium text-[#8D8D86] text-[10px]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  className="flex w-12 flex-col items-center gap-[1px] rounded-lg bg-[#F9F9F8] pt-[6px] pb-1 font-medium text-[#8D8D86] text-[10px] hover:bg-[#FFF7F7] hover:text-[#E5484D]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
        ...
        {readyToRemove ? (
          ...
          >
            <button
              ...
              className="flex h-8 w-[200px] items-center justify-center gap-[15px] rounded-full bg-[#FF3F40] text-center font-semibold text-[#FFFFFF] text-[13px]"
            >
        ...
        <AnimatePresence>
          {readyToRemove ? (
            <div className="-translate-y-1/2 absolute top-1/2 z-10 h-[114px] w-24">
              <motion.div
